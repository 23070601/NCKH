...
def check_existing_evaluation(output_dir: Path = Path('data/results/evaluation')):
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='data/results/evaluation',
    ...
    if exists and not args.force:
        ...
        print("  Use --force flag to re-evaluate: python pipeline/07_evaluate.py --force")
        return
